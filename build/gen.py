...
def WriteGNNinja(path, platform, host, options):
  ...
  static_libraries = {
      ...
      'gn_lib': {'sources': [
        ...
        'src/gn/csharp_substitution_type.cc',
        'src/gn/csharp_tool.cc',
        'src/gn/csharp_values.cc',
        'src/gn/csharp_values_generator.cc',
        'src/gn/csharp_variables.cc',
        ...
        'src/gn/ninja_csharp_assembly_target_writer.cc',
  ...
  executables = {
      ...
      'gn_unittests': { 'sources': [
        ...
        'src/gn/functions_target_csharp_unittest.cc',
        ...
        'src/gn/ninja_csharp_assembly_target_writer_unittest.cc',
